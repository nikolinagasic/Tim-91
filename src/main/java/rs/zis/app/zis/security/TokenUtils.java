package rs.zis.app.zis.security;
...
public class TokenUtils {
    ...
    public String generateToken(String username) {
        return Jwts.builder()
                .setIssuer(APP_NAME)
                .setSubject(username)               // kome izdajem
                .setAudience(generateAudience())        // web, mobile ...
                .setIssuedAt(timeProvider.now())            // kad sam izdao
                .setExpiration(generateExpirationDate())        // koliko traje
    ...
    public String refreshToken(String token) {      // istekao je token, ali je sve validno -> daj mi novi token
