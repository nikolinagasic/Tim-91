...
insert into users (enabled, first_login, last_password_reset_date, mail, password)
    values (true, true, '2017-10-01 21:58:58.508-07', 'admin@gmail.com','$2a$04$SwzgBrIJZhfnzOw7KFcdzOTiY6EFVwIpG7fkF/D1w26G1.fWsi.aK');
...
--d1
insert into users (enabled, first_login, last_password_reset_date, mail, password)
    values (true, true, '2017-10-01 21:58:58.508-07', 'doctor@gmail.com','$2a$04$SwzgBrIJZhfnzOw7KFcdzOTiY6EFVwIpG7fkF/D1w26G1.fWsi.aK');
...
--d2
insert into users (enabled, first_login, last_password_reset_date, mail, password)
    values (true, true, '2017-10-01 21:58:58.508-07', 'doctor1@gmail.com','$2a$04$SwzgBrIJZhfnzOw7KFcdzOTiY6EFVwIpG7fkF/D1w26G1.fWsi.aK');
insert into doctor (price, first_name, last_name, role, rating, id, clinic_id, tip_id)
    values (5500.00, 'Marinko', 'Marinkovic', 'doctor', 4.5, 3, 2, 1);
-- d3
insert into users (enabled, first_login, last_password_reset_date, mail, password)
    values (true, true, '2017-10-01 21:58:58.508-07', 'doctor3@gmail.com','$2a$04$SwzgBrIJZhfnzOw7KFcdzOTiY6EFVwIpG7fkF/D1w26G1.fWsi.aK');
insert into doctor (price, first_name, last_name, role, rating, id, clinic_id, tip_id)
